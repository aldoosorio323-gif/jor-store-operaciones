...
- `reserved_stock` se modifica únicamente dentro de transacciones de Etapa 4: reservar aumenta reservado sin cambiar físico; liberar lo reduce; despachar reduce físico y reservado por igual.
