...
describe("fronteras de seguridad de Etapa 3", () => {
  it("muestra operación a ambos roles y ajustes solo al administrador", () => {
  ...
  it("usa RPC para cada transición crítica", () => {
    for (const rpc of [
  ...
  it("exige una fila en mutaciones directas y no comunica éxitos con cero filas", () => {
